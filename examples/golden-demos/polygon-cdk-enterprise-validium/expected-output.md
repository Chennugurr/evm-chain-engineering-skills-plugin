...
Use a staged, review-first plan centered on CDK modes, Agglayer, DA, bridge, prover/aggregator, enterprise operations, governance, security risks, launch checklist. Exact stack commands and server requirements remain `VERIFY_CURRENT_DOCS` before production use.
...
Cover these required concepts: CDK modes, Agglayer, DA, bridge, prover/aggregator, enterprise operations, governance, security risks, launch checklist.
