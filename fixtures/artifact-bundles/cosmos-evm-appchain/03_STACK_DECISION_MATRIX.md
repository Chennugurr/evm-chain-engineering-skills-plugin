# Stack Decision Matrix: Example Cosmos EVM Appchain
...
|---|---|---|---|---|---|---|---|---|
| Cosmos EVM Appchain | fits `appchain` | native-cometbft | native-cometbft-chain | cometbft-finality | verify current docs | medium/high | bridge, keys, RPC, DA | selected |
