...
|---|---|---|---|---|---|---|---|---|
| Polygon CDK | fits `validium` | ethereum-testnet-or-agglayer | offchain-da-committee | validity-proof | verify current docs | medium/high | bridge, keys, RPC, DA | selected |
