# Stack Decision Matrix: Example ZK Stack Validium
...
|---|---|---|---|---|---|---|---|---|
| ZKsync ZK Stack | fits `validium` | ethereum-testnet | validium-da | validity-proof | verify current docs | medium/high | bridge, keys, RPC, DA | selected |
