# Request: Example OP Stack Public Testnet

- Original or normalized request: generate a safe planning artifact bundle for `op-stack-public-testnet`.
- Workflow id: `op-stack-public-testnet`
