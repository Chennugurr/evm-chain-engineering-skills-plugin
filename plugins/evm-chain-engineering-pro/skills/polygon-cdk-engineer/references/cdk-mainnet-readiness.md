# Cdk Mainnet Readiness

## Purpose

Provide focused guidance for `cdk-mainnet-readiness.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves cdk, mainnet, readiness or adjacent architecture, configuration, operations, or safety decisions.
...
For Polygon CDK work, identify sovereign, validium, or zkRollup mode, Agglayer connectivity, execution client, privacy requirements, and managed versus self-managed assumptions.
