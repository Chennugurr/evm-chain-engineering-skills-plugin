...
Provide focused guidance for `cdk-architecture.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves cdk, architecture or adjacent architecture, configuration, operations, or safety decisions.
