...
Provide focused guidance for `cdk-troubleshooting.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves cdk, troubleshooting or adjacent architecture, configuration, operations, or safety decisions.
