...
Provide focused guidance for `da-cost-models.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves da, cost, models or adjacent architecture, configuration, operations, or safety decisions.
