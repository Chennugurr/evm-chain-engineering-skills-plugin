...
Provide focused guidance for `da-monitoring.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves da, monitoring or adjacent architecture, configuration, operations, or safety decisions.
