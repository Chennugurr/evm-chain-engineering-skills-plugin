...
Provide focused guidance for `eigenda.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves eigenda or adjacent architecture, configuration, operations, or safety decisions.
