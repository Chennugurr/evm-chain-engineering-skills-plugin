...
Provide focused guidance for `da-selection-guide.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves da, selection, guide or adjacent architecture, configuration, operations, or safety decisions.
