...
Provide focused guidance for `da-failure-modes.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves da, failure, modes or adjacent architecture, configuration, operations, or safety decisions.
