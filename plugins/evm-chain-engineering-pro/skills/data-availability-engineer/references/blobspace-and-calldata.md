# Blobspace And Calldata

## Purpose

Provide focused guidance for `blobspace-and-calldata.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves blobspace, and, calldata or adjacent architecture, configuration, operations, or safety decisions.
...
For data availability work, make the DA trust assumption explicit and monitor data publication, retention, retrieval, and fallback paths.
