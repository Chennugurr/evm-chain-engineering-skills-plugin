...
Provide focused guidance for `private-da.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves private, da or adjacent architecture, configuration, operations, or safety decisions.
