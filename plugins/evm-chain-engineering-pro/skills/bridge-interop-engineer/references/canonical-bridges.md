...
Provide focused guidance for `canonical-bridges.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves canonical, bridges or adjacent architecture, configuration, operations, or safety decisions.
