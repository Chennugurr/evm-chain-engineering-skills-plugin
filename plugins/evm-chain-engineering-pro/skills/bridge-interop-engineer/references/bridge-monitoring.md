...
Provide focused guidance for `bridge-monitoring.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bridge, monitoring or adjacent architecture, configuration, operations, or safety decisions.
