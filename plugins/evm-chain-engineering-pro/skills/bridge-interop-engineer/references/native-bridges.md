...
Provide focused guidance for `native-bridges.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves native, bridges or adjacent architecture, configuration, operations, or safety decisions.
