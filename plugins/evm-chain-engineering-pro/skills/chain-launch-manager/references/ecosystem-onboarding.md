...
Provide focused guidance for `ecosystem-onboarding.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves ecosystem, onboarding or adjacent architecture, configuration, operations, or safety decisions.
