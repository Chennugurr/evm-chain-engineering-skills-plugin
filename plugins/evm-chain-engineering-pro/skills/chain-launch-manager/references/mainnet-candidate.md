...
Provide focused guidance for `mainnet-candidate.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves mainnet, candidate or adjacent architecture, configuration, operations, or safety decisions.
