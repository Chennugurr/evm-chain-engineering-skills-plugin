...
Provide focused guidance for `incident-response.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves incident, response or adjacent architecture, configuration, operations, or safety decisions.
