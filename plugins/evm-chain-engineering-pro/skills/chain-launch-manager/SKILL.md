...
Plan phased chain launches, readiness gates, communications, governance handoff, and post-launch operations.
...
- `references/testnet-launch.md`
- `references/mainnet-candidate.md`
- `references/mainnet-launch.md`
- `references/mainnet-readiness.md`
- `references/governance-handoff.md`
- `references/launch-communications.md`
- `references/ecosystem-onboarding.md`
- `references/post-launch-ops.md`
- `references/incident-response.md`
- `references/l1-launch-runbook.md`
