...
Provide focused guidance for `dymension-rollapps.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves dymension, rollapps or adjacent architecture, configuration, operations, or safety decisions.
