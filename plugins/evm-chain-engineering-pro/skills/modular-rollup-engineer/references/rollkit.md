...
Provide focused guidance for `rollkit.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rollkit or adjacent architecture, configuration, operations, or safety decisions.
