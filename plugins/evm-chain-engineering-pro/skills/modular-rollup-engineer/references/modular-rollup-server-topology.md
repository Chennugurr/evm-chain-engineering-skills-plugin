# Modular Rollup Server Topology

## Purpose

Provide focused guidance for `modular-rollup-server-topology.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves modular, rollup, server, topology or adjacent architecture, configuration, operations, or safety decisions.
