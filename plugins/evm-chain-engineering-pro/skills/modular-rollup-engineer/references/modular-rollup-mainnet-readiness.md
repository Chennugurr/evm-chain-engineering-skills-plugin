# Modular Rollup Mainnet Readiness

## Purpose

Provide focused guidance for `modular-rollup-mainnet-readiness.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves modular, rollup, mainnet, readiness or adjacent architecture, configuration, operations, or safety decisions.
