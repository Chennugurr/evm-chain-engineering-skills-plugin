# Op Node Op Geth Op Reth

## Purpose

Provide focused guidance for `op-node-op-geth-op-reth.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves op, node, op, geth, op, reth or adjacent architecture, configuration, operations, or safety decisions.
