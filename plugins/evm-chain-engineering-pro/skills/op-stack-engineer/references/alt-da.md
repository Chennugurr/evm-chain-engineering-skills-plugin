...
Provide focused guidance for `alt-da.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves alt, da or adjacent architecture, configuration, operations, or safety decisions.
