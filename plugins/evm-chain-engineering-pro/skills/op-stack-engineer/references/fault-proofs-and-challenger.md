# Fault Proofs And Challenger

## Purpose

Provide focused guidance for `fault-proofs-and-challenger.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves fault, proofs, and, challenger or adjacent architecture, configuration, operations, or safety decisions.
