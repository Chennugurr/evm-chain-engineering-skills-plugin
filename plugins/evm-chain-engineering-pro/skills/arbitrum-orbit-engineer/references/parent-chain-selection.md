...
Provide focused guidance for `parent-chain-selection.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves parent, chain, selection or adjacent architecture, configuration, operations, or safety decisions.
