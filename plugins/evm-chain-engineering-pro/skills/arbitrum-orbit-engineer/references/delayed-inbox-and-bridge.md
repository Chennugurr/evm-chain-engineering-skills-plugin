# Delayed Inbox And Bridge

## Purpose

Provide focused guidance for `delayed-inbox-and-bridge.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves delayed, inbox, and, bridge or adjacent architecture, configuration, operations, or safety decisions.
