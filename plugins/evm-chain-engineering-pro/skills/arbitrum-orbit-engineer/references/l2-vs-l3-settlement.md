...
Provide focused guidance for `l2-vs-l3-settlement.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves l2, vs, l3, settlement or adjacent architecture, configuration, operations, or safety decisions.
