...
Provide focused guidance for `anytrust-and-dacs.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves anytrust, and, dacs or adjacent architecture, configuration, operations, or safety decisions.
