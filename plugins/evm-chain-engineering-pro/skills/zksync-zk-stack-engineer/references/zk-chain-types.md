...
Provide focused guidance for `zk-chain-types.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves zk, chain, types or adjacent architecture, configuration, operations, or safety decisions.
