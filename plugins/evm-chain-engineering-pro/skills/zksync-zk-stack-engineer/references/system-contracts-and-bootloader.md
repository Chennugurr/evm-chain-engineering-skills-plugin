...
Provide focused guidance for `system-contracts-and-bootloader.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves system, contracts, and, bootloader or adjacent architecture, configuration, operations, or safety decisions.
