...
Provide focused guidance for `custom-base-token.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves custom, base, token or adjacent architecture, configuration, operations, or safety decisions.
