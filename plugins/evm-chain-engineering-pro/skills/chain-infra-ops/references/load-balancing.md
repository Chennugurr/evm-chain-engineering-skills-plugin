...
Provide focused guidance for `load-balancing.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves load, balancing or adjacent architecture, configuration, operations, or safety decisions.
