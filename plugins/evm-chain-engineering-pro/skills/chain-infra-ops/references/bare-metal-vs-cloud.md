...
Provide focused guidance for `bare-metal-vs-cloud.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bare, metal, vs, cloud or adjacent architecture, configuration, operations, or safety decisions.
