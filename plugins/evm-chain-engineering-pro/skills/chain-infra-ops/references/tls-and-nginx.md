...
Provide focused guidance for `tls-and-nginx.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves tls, and, nginx or adjacent architecture, configuration, operations, or safety decisions.
