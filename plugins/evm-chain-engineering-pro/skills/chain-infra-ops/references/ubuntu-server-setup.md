...
Provide focused guidance for `ubuntu-server-setup.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves ubuntu, server, setup or adjacent architecture, configuration, operations, or safety decisions.
