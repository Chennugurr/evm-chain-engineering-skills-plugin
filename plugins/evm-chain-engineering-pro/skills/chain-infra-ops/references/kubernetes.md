...
Provide focused guidance for `kubernetes.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves kubernetes or adjacent architecture, configuration, operations, or safety decisions.
