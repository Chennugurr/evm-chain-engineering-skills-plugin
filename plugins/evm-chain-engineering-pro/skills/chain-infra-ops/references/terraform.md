...
Provide focused guidance for `terraform.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves terraform or adjacent architecture, configuration, operations, or safety decisions.
