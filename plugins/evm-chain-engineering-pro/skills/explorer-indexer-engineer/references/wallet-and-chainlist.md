# Wallet And Chainlist

## Purpose

Provide focused guidance for `wallet-and-chainlist.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves wallet, and, chainlist or adjacent architecture, configuration, operations, or safety decisions.
