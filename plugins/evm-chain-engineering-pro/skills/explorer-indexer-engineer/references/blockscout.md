...
Provide focused guidance for `blockscout.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves blockscout or adjacent architecture, configuration, operations, or safety decisions.
