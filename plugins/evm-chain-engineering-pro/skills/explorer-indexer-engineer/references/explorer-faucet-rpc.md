...
Provide focused guidance for `explorer-faucet-rpc.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves explorer, faucet, rpc or adjacent architecture, configuration, operations, or safety decisions.
