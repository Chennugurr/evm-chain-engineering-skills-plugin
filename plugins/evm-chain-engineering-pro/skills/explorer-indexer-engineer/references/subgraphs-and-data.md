...
Provide focused guidance for `subgraphs-and-data.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves subgraphs, and, data or adjacent architecture, configuration, operations, or safety decisions.
