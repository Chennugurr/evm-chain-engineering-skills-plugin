...
Provide focused guidance for `chain-metadata.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves chain, metadata or adjacent architecture, configuration, operations, or safety decisions.
