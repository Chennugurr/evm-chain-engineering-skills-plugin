...
Provide focused guidance for `token-lists.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves token, lists or adjacent architecture, configuration, operations, or safety decisions.
