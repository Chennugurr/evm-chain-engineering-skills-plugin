...
Provide focused guidance for `faucets.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves faucets or adjacent architecture, configuration, operations, or safety decisions.
