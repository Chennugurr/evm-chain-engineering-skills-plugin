# Chainlist And Wallets

## Purpose

Provide focused guidance for `chainlist-and-wallets.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves chainlist, and, wallets or adjacent architecture, configuration, operations, or safety decisions.
