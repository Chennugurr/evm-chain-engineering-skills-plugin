...
Provide focused guidance for `audit-preparation.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves audit, preparation or adjacent architecture, configuration, operations, or safety decisions.
