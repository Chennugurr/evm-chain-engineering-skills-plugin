...
Provide focused guidance for `precompile-review.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves precompile, review or adjacent architecture, configuration, operations, or safety decisions.
