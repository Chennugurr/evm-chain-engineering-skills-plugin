...
Provide focused guidance for `governance-and-upgrades.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves governance, and, upgrades or adjacent architecture, configuration, operations, or safety decisions.
