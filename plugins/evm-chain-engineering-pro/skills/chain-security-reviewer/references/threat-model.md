...
Provide focused guidance for `threat-model.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves threat, model or adjacent architecture, configuration, operations, or safety decisions.
