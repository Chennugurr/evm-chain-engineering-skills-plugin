...
Provide focused guidance for `rpc-health-checks.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rpc, health, checks or adjacent architecture, configuration, operations, or safety decisions.
