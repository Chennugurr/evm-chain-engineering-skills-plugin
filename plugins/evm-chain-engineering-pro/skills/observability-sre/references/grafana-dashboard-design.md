...
Provide focused guidance for `grafana-dashboard-design.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves grafana, dashboard, design or adjacent architecture, configuration, operations, or safety decisions.
