# Rollup Health Checks

## Purpose

Provide focused guidance for `rollup-health-checks.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rollup, health, checks or adjacent architecture, configuration, operations, or safety decisions.
