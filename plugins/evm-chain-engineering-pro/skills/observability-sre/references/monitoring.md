...
Provide focused guidance for `monitoring.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves monitoring or adjacent architecture, configuration, operations, or safety decisions.
