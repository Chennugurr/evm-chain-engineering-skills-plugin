# Fork Schedule And Upgrades

## Purpose

Provide focused guidance for `fork-schedule-and-upgrades.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves fork, schedule, and, upgrades or adjacent architecture, configuration, operations, or safety decisions.
