...
Provide focused guidance for `ethereum-like-l1.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves ethereum, like, l1 or adjacent architecture, configuration, operations, or safety decisions.
