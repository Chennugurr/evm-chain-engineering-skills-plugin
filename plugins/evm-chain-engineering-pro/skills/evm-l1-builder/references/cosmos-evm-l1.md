...
Provide focused guidance for `cosmos-evm-l1.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves cosmos, evm, l1 or adjacent architecture, configuration, operations, or safety decisions.
