...
Provide focused guidance for `precompiles.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves precompiles or adjacent architecture, configuration, operations, or safety decisions.
