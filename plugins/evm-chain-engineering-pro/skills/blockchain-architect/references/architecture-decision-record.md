...
Provide focused guidance for `architecture-decision-record.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves architecture, decision, record or adjacent architecture, configuration, operations, or safety decisions.
