...
Provide focused guidance for `l1-vs-l2-vs-l3.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves l1, vs, l2, vs, l3 or adjacent architecture, configuration, operations, or safety decisions.
