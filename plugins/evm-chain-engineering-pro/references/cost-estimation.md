...
Provide focused guidance for `cost-estimation.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves cost, estimation or adjacent architecture, configuration, operations, or safety decisions.
