# Bridge And L1 Contracts

## Purpose

Provide focused guidance for `bridge-and-l1-contracts.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bridge, and, l1, contracts or adjacent architecture, configuration, operations, or safety decisions.
