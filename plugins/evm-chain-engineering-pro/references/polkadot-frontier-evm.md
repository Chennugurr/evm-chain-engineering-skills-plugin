# Polkadot Frontier EVM

## Purpose

Provide focused guidance for `polkadot-frontier-evm.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves polkadot, frontier, evm or adjacent architecture, configuration, operations, or safety decisions.
