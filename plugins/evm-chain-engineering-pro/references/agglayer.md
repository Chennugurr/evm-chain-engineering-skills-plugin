...
Provide focused guidance for `agglayer.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves agglayer or adjacent architecture, configuration, operations, or safety decisions.
