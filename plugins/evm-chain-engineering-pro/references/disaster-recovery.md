...
Provide focused guidance for `disaster-recovery.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves disaster, recovery or adjacent architecture, configuration, operations, or safety decisions.
