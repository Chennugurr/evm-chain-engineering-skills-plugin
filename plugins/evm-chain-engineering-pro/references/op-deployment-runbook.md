# Op Deployment Runbook

## Purpose

Provide focused guidance for `op-deployment-runbook.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves op, deployment, runbook or adjacent architecture, configuration, operations, or safety decisions.
