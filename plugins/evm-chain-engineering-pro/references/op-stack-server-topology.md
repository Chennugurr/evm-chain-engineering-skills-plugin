# Op Stack Server Topology

## Purpose

Provide focused guidance for `op-stack-server-topology.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves op, stack, server, topology or adjacent architecture, configuration, operations, or safety decisions.
