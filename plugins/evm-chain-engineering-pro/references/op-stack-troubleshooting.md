# Op Stack Troubleshooting

## Purpose

Provide focused guidance for `op-stack-troubleshooting.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves op, stack, troubleshooting or adjacent architecture, configuration, operations, or safety decisions.
