...
Provide focused guidance for `avail-da.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves avail, da or adjacent architecture, configuration, operations, or safety decisions.
