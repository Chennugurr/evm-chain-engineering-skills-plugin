...
Provide focused guidance for `developer-apis.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves developer, apis or adjacent architecture, configuration, operations, or safety decisions.
