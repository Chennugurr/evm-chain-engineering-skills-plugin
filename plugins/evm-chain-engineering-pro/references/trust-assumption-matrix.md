# Trust Assumption Matrix

## Purpose

Provide focused guidance for `trust-assumption-matrix.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves trust, assumption, matrix or adjacent architecture, configuration, operations, or safety decisions.
