...
Provide focused guidance for `security-models.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves security, models or adjacent architecture, configuration, operations, or safety decisions.
