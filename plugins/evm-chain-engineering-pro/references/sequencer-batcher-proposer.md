...
Provide focused guidance for `sequencer-batcher-proposer.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sequencer, batcher, proposer or adjacent architecture, configuration, operations, or safety decisions.
