...
Provide focused guidance for `custom-gas-token.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves custom, gas, token or adjacent architecture, configuration, operations, or safety decisions.
