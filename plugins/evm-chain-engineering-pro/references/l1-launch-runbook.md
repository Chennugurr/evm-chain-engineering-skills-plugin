...
Provide focused guidance for `l1-launch-runbook.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves l1, launch, runbook or adjacent architecture, configuration, operations, or safety decisions.
