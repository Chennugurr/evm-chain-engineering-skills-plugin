...
Provide focused guidance for `orbit-troubleshooting.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves orbit, troubleshooting or adjacent architecture, configuration, operations, or safety decisions.
