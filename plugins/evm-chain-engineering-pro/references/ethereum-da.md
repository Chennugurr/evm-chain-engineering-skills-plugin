...
Provide focused guidance for `ethereum-da.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves ethereum, da or adjacent architecture, configuration, operations, or safety decisions.
