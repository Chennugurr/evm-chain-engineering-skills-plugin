...
Provide focused guidance for `shared-sequencing.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves shared, sequencing or adjacent architecture, configuration, operations, or safety decisions.
