...
Provide focused guidance for `chain-id-and-replay-protection.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves chain, id, and, replay, protection or adjacent architecture, configuration, operations, or safety decisions.
