...
Provide focused guidance for `bnb-style-posa-l1.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bnb, style, posa, l1 or adjacent architecture, configuration, operations, or safety decisions.
