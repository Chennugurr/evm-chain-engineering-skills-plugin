...
Provide focused guidance for `backup-verification.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves backup, verification or adjacent architecture, configuration, operations, or safety decisions.
