# Sovereign Validium Zkrollup Modes

## Purpose

Provide focused guidance for `sovereign-validium-zkrollup-modes.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sovereign, validium, zkrollup, modes or adjacent architecture, configuration, operations, or safety decisions.
...
For ZKsync ZK Stack work, distinguish local dummy-executor testing from prover-backed deployments and verify current prover hardware and base token restrictions.
