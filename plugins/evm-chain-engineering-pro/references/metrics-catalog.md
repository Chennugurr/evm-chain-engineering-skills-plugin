...
Provide focused guidance for `metrics-catalog.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves metrics, catalog or adjacent architecture, configuration, operations, or safety decisions.
