...
Provide focused guidance for `data-availability-risk.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves data, availability, risk or adjacent architecture, configuration, operations, or safety decisions.
