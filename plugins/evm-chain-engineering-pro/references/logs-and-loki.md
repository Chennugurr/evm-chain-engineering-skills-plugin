...
Provide focused guidance for `logs-and-loki.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves logs, and, loki or adjacent architecture, configuration, operations, or safety decisions.
