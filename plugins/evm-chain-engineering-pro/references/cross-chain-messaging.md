...
Provide focused guidance for `cross-chain-messaging.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves cross, chain, messaging or adjacent architecture, configuration, operations, or safety decisions.
