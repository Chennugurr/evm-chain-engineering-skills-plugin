# Infra Mainnet Readiness

## Purpose

Provide focused guidance for `infra-mainnet-readiness.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves infra, mainnet, readiness or adjacent architecture, configuration, operations, or safety decisions.
...
For infrastructure work, separate public and private endpoints, pin images, isolate signers, use least privilege, and document backup and restore drills.
