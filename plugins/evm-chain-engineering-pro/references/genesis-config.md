...
Provide focused guidance for `genesis-config.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves genesis, config or adjacent architecture, configuration, operations, or safety decisions.
