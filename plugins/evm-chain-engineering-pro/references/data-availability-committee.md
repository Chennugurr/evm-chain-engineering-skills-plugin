...
Provide focused guidance for `data-availability-committee.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves data, availability, committee or adjacent architecture, configuration, operations, or safety decisions.
