...
Provide focused guidance for `sovereign-sdk.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sovereign, sdk or adjacent architecture, configuration, operations, or safety decisions.
