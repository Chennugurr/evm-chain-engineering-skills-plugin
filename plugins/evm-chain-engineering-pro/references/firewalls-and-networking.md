...
Provide focused guidance for `firewalls-and-networking.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves firewalls, and, networking or adjacent architecture, configuration, operations, or safety decisions.
