...
Provide focused guidance for `sovereign-vs-settled-rollups.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sovereign, vs, settled, rollups or adjacent architecture, configuration, operations, or safety decisions.
