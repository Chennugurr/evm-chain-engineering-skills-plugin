...
Provide focused guidance for `indexer-architecture.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves indexer, architecture or adjacent architecture, configuration, operations, or safety decisions.
