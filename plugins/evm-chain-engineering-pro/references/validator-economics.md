...
Provide focused guidance for `validator-economics.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves validator, economics or adjacent architecture, configuration, operations, or safety decisions.
