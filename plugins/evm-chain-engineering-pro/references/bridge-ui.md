...
Provide focused guidance for `bridge-ui.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bridge, ui or adjacent architecture, configuration, operations, or safety decisions.
