...
Provide focused guidance for `contract-verification.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves contract, verification or adjacent architecture, configuration, operations, or safety decisions.
