...
Provide focused guidance for `launch-phases.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves launch, phases or adjacent architecture, configuration, operations, or safety decisions.
