# Enterprise Permissioned Deployments

## Purpose

Provide focused guidance for `enterprise-permissioned-deployments.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves enterprise, permissioned, deployments or adjacent architecture, configuration, operations, or safety decisions.
...
Use this reference to force explicit choices, safety gates, current-doc verification, and clear operator runbooks before implementation.
