...
Provide focused guidance for `sequencer-risk.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sequencer, risk or adjacent architecture, configuration, operations, or safety decisions.
