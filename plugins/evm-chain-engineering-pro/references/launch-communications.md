...
Provide focused guidance for `launch-communications.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves launch, communications or adjacent architecture, configuration, operations, or safety decisions.
