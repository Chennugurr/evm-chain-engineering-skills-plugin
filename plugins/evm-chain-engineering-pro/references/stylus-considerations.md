...
Provide focused guidance for `stylus-considerations.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves stylus, considerations or adjacent architecture, configuration, operations, or safety decisions.
