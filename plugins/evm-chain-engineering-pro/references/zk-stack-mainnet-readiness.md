# ZK Stack Mainnet Readiness

## Purpose

Provide focused guidance for `zk-stack-mainnet-readiness.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves zk, stack, mainnet, readiness or adjacent architecture, configuration, operations, or safety decisions.
