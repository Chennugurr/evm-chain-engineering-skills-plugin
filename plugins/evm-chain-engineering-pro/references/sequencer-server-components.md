# Sequencer Server Components

## Purpose

Provide focused guidance for `sequencer-server-components.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sequencer, server, components or adjacent architecture, configuration, operations, or safety decisions.
