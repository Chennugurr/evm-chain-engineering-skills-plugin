...
Provide focused guidance for `helm.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves helm or adjacent architecture, configuration, operations, or safety decisions.
