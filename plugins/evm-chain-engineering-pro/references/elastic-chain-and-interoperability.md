# Elastic Chain And Interoperability

## Purpose

Provide focused guidance for `elastic-chain-and-interoperability.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves elastic, chain, and, interoperability or adjacent architecture, configuration, operations, or safety decisions.
...
For OP Stack work, separate sequencer, batcher, proposer, challenger, execution client, and consensus client roles. Verify current Optimism docs before using exact op-deployer or client commands.
