...
Provide focused guidance for `rollup-vs-anytrust.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rollup, vs, anytrust or adjacent architecture, configuration, operations, or safety decisions.
