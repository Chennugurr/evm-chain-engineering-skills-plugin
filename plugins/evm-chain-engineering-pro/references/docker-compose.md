...
Provide focused guidance for `docker-compose.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves docker, compose or adjacent architecture, configuration, operations, or safety decisions.
