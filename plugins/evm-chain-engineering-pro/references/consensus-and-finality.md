...
Provide focused guidance for `consensus-and-finality.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves consensus, and, finality or adjacent architecture, configuration, operations, or safety decisions.
