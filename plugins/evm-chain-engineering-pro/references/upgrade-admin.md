...
Provide focused guidance for `upgrade-admin.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves upgrade, admin or adjacent architecture, configuration, operations, or safety decisions.
