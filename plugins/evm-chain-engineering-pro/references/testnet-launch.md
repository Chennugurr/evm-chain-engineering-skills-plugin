...
Provide focused guidance for `testnet-launch.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves testnet, launch or adjacent architecture, configuration, operations, or safety decisions.
