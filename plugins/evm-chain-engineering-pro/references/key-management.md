...
Provide focused guidance for `key-management.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves key, management or adjacent architecture, configuration, operations, or safety decisions.
