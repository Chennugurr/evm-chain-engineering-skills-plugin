...
Provide focused guidance for `relayers.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves relayers or adjacent architecture, configuration, operations, or safety decisions.
