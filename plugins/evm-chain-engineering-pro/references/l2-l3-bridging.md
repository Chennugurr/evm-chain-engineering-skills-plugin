...
Provide focused guidance for `l2-l3-bridging.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves l2, l3, bridging or adjacent architecture, configuration, operations, or safety decisions.
