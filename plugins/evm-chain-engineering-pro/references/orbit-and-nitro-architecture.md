# Orbit And Nitro Architecture

## Purpose

Provide focused guidance for `orbit-and-nitro-architecture.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves orbit, and, nitro, architecture or adjacent architecture, configuration, operations, or safety decisions.
...
For Arbitrum Orbit work, identify the parent chain, Rollup versus AnyTrust mode, validator assumptions, custom gas token constraints, and bridge route before deployment planning.
