...
Provide focused guidance for `server-sizing.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves server, sizing or adjacent architecture, configuration, operations, or safety decisions.
