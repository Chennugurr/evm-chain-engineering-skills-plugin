...
Provide focused guidance for `post-launch-ops.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves post, launch, ops or adjacent architecture, configuration, operations, or safety decisions.
