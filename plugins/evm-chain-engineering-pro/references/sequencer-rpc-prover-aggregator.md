# Sequencer RPC Prover Aggregator

## Purpose

Provide focused guidance for `sequencer-rpc-prover-aggregator.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sequencer, rpc, prover, aggregator or adjacent architecture, configuration, operations, or safety decisions.
...
For RPC work, keep admin/debug endpoints private, rate-limit public methods, monitor latency and error rates, and avoid exposing internal metrics publicly.
