...
Provide focused guidance for `postmortems.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves postmortems or adjacent architecture, configuration, operations, or safety decisions.
