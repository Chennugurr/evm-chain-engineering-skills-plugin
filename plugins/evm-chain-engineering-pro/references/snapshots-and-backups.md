...
Provide focused guidance for `snapshots-and-backups.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves snapshots, and, backups or adjacent architecture, configuration, operations, or safety decisions.
