...
Provide focused guidance for `execution-client-options.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves execution, client, options or adjacent architecture, configuration, operations, or safety decisions.
