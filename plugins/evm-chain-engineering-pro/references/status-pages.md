...
Provide focused guidance for `status-pages.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves status, pages or adjacent architecture, configuration, operations, or safety decisions.
