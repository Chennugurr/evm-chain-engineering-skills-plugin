# ZK Stack Troubleshooting

## Purpose

Provide focused guidance for `zk-stack-troubleshooting.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves zk, stack, troubleshooting or adjacent architecture, configuration, operations, or safety decisions.
