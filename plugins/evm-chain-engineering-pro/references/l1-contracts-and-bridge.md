# L1 Contracts And Bridge

## Purpose

Provide focused guidance for `l1-contracts-and-bridge.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves l1, contracts, and, bridge or adjacent architecture, configuration, operations, or safety decisions.
