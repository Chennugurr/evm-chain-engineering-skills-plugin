...
Provide focused guidance for `dac-and-da-models.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves dac, and, da, models or adjacent architecture, configuration, operations, or safety decisions.
