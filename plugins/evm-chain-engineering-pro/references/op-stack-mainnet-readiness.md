# Op Stack Mainnet Readiness

## Purpose

Provide focused guidance for `op-stack-mainnet-readiness.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves op, stack, mainnet, readiness or adjacent architecture, configuration, operations, or safety decisions.
