...
Provide focused guidance for `ansible.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves ansible or adjacent architecture, configuration, operations, or safety decisions.
