...
Provide focused guidance for `avalanche-l1-subnet-evm.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves avalanche, l1, subnet, evm or adjacent architecture, configuration, operations, or safety decisions.
