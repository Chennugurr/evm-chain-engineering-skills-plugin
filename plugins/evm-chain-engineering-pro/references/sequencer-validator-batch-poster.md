# Sequencer Validator Batch Poster

## Purpose

Provide focused guidance for `sequencer-validator-batch-poster.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sequencer, validator, batch, poster or adjacent architecture, configuration, operations, or safety decisions.
...
For data availability work, make the DA trust assumption explicit and monitor data publication, retention, retrieval, and fallback paths. For validator work, separate consensus keys from administrative keys, define rotation procedures, monitor liveness, and document slashing or jailing risks.
