...
Provide focused guidance for `superchain-compatibility.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves superchain, compatibility or adjacent architecture, configuration, operations, or safety decisions.
