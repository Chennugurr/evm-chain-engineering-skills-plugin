...
Provide focused guidance for `systemd.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves systemd or adjacent architecture, configuration, operations, or safety decisions.
