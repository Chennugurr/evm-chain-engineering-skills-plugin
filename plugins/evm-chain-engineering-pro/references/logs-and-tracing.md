...
Provide focused guidance for `logs-and-tracing.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves logs, and, tracing or adjacent architecture, configuration, operations, or safety decisions.
