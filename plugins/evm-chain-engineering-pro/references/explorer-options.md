...
Provide focused guidance for `explorer-options.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves explorer, options or adjacent architecture, configuration, operations, or safety decisions.
