...
Provide focused guidance for `rollup-vs-validium.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rollup, vs, validium or adjacent architecture, configuration, operations, or safety decisions.
