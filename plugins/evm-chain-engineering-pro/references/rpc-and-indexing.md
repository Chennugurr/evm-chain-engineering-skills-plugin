...
Provide focused guidance for `rpc-and-indexing.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rpc, and, indexing or adjacent architecture, configuration, operations, or safety decisions.
