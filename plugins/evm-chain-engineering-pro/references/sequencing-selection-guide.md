# Sequencing Selection Guide

## Purpose

Provide focused guidance for `sequencing-selection-guide.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves sequencing, selection, guide or adjacent architecture, configuration, operations, or safety decisions.
