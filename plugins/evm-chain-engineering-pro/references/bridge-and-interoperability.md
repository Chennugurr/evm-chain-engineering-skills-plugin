...
Provide focused guidance for `bridge-and-interoperability.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bridge, and, interoperability or adjacent architecture, configuration, operations, or safety decisions.
...
For OP Stack work, separate sequencer, batcher, proposer, challenger, execution client, and consensus client roles. Verify current Optimism docs before using exact op-deployer or client commands. For bridge work, model canonical routes, parent-chain constraints, token mapping, relayer trust, replay protection, withdrawal delays, and TVL limits.
