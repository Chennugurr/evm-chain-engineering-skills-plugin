...
Provide focused guidance for `incident-command.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves incident, command or adjacent architecture, configuration, operations, or safety decisions.
