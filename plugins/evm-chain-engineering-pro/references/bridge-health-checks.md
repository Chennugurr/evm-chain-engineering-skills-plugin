...
Provide focused guidance for `bridge-health-checks.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves bridge, health, checks or adjacent architecture, configuration, operations, or safety decisions.
