...
Provide focused guidance for `governance-handoff.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves governance, handoff or adjacent architecture, configuration, operations, or safety decisions.
