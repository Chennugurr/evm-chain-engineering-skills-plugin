...
Provide focused guidance for `prometheus-alerts.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves prometheus, alerts or adjacent architecture, configuration, operations, or safety decisions.
