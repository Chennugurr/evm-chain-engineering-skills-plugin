...
Provide focused guidance for `stack-selection-matrix.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves stack, selection, matrix or adjacent architecture, configuration, operations, or safety decisions.
