...
Provide focused guidance for `grafana-dashboards.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves grafana, dashboards or adjacent architecture, configuration, operations, or safety decisions.
