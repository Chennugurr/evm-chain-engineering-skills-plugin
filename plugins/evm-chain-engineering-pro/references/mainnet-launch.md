...
Provide focused guidance for `mainnet-launch.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves mainnet, launch or adjacent architecture, configuration, operations, or safety decisions.
