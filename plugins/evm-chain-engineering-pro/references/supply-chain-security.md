...
Provide focused guidance for `supply-chain-security.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves supply, chain, security or adjacent architecture, configuration, operations, or safety decisions.
...
For security work, identify assets, actors, admin keys, upgrade powers, emergency controls, and launch blockers before giving a go/no-go result.
