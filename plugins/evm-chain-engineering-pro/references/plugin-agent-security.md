...
Provide focused guidance for `plugin-agent-security.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves plugin, agent, security or adjacent architecture, configuration, operations, or safety decisions.
