...
Provide focused guidance for `token-mapping.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves token, mapping or adjacent architecture, configuration, operations, or safety decisions.
