...
Provide focused guidance for `celestia-da.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves celestia, da or adjacent architecture, configuration, operations, or safety decisions.
