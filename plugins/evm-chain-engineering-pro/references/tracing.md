...
Provide focused guidance for `tracing.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves tracing or adjacent architecture, configuration, operations, or safety decisions.
