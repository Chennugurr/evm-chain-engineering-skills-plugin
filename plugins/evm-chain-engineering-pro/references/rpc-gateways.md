...
Provide focused guidance for `rpc-gateways.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves rpc, gateways or adjacent architecture, configuration, operations, or safety decisions.
