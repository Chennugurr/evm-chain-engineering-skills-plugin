...
Provide focused guidance for `op-stack-architecture.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves op, stack, architecture or adjacent architecture, configuration, operations, or safety decisions.
