# Modular Stack Registry

## Purpose

Provide focused guidance for `modular-stack-registry.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves modular, stack, registry or adjacent architecture, configuration, operations, or safety decisions.
