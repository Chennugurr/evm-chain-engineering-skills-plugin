...
Provide focused guidance for `zk-stack-architecture.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves zk, stack, architecture or adjacent architecture, configuration, operations, or safety decisions.
