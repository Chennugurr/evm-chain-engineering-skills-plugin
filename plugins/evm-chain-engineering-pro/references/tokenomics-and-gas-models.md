# Tokenomics And Gas Models

## Purpose

Provide focused guidance for `tokenomics-and-gas-models.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves tokenomics, and, gas, models or adjacent architecture, configuration, operations, or safety decisions.
