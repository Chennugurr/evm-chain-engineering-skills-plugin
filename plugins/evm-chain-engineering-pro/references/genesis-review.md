...
Provide focused guidance for `genesis-review.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves genesis, review or adjacent architecture, configuration, operations, or safety decisions.
