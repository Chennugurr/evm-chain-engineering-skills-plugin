...
Provide focused guidance for `prover-setup.md` within the EVM Chain Engineering Plugin.

## Applies To

Use when the task involves prover, setup or adjacent architecture, configuration, operations, or safety decisions.
