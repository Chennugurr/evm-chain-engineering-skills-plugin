# Security Review: Example CDK Enterprise Validium
...
Signer material, recovery phrases, keystore passwords, and deployer credentials must stay outside git. Use <INJECT_FROM_SECURE_SIGNER_AT_RUNTIME>.
...
DA mode `offchain-da-committee` requires explicit failure-mode review.
